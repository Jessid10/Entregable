...
import Logica.TeoremaPitagoras;
import entregable.Entregable;
import java.lang.System.*;
import javax.swing.JFrame;


public class JFrameTeoremaPitagoras extends javax.swing.JFrame {

    /**
     * Creates new form JFrameTeoremaPitagoras
     */
    public JFrameTeoremaPitagoras() {
        initComponents();
    }
    ...
    private void btnCalcularActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCalcularActionPerformed
        ...
        TeoremaPitagoras  TeoPi=new TeoremaPitagoras();
        try {
            double lado1 = Double.parseDouble (txtLado1.getText());
            double lado2 = Double.parseDouble (txtLado2.getText());

            double hipotenusa = TeoPi.CalcularHipotenusa (lado1, lado2);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFrameTeoremaPitagoras.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFrameTeoremaPitagoras().setVisible(true);
            }
        });
    }
